...
class CustomAuthenticationForm(AuthenticationForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['password'].widget.attrs.update({'class': 'main-input', 'placeholder': 'Enter Password'})
...
class CustomUserChangeForm(UserChangeForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['username'].widget.attrs.update({'class': 'main-input', 'placeholder': 'Enter Username'})
        self.fields['email'].widget.attrs.update({'class': 'main-input', 'placeholder': 'Enter Email'})
        self.fields['first_name'].widget.attrs.update({'class': 'main-input', 'placeholder': 'Enter Your First Name'})
        self.fields['last_name'].widget.attrs.update({'class': 'main-input', 'placeholder': 'Enter Your Last Name'})
