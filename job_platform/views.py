...
class SignUpView(View):
    ...
    context = {"page": "signup", "css_file": "sign_page.css"}
...
class SignInView(View):
    ...
    context = {"page": "signin", "css_file": "sign_page.css"}
...
class UserPageView(View):
    ...
    context = {"page": "user", "css_file": "user_page.css"}
    ...
    def get(self, request):
        ...
        applications_today = Application.objects.filter(
            date_applied__date=today, user=request.user
        ).count()
        applications_this_week = Application.objects.filter(
            date_applied__date__gte=start_of_week, user=request.user
        ).count()
        applications_this_month = Application.objects.filter(
            date_applied__date__gte=start_of_month, user=request.user
        ).count()
